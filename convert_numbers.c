...
/**
 * convert_b - Converts an unsigned int to binary and stores it to a buffer.
 * @args: A va_list pointing to the argument to be converted.
 * @flags: Flag modifiers.
 * @wid: A width modifier.
 * @prec: A precision modifier.
...
/**
 * convert_o - Converts an unsigned int to octal and store it to a buffer.
...
/**
 * convert_u - Convert an unsigned int to decimal and store it to a buffer.
 * @args: A va_list pointing to the argument to be converted.
 * @flags: Flag modifiers.
 * @wid: A width modifier.
 * @prec: A precision modifier.
